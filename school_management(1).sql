...
INSERT INTO `students` (`student_id`, `full_name`, `image`, `class_id`, `birth_date`, `gender`) VALUES
(1, 'أريج حسام وافي', NULL, NULL, '2003-07-26', 'أنثى'),
(3, 'براءة وافي', NULL, NULL, '2005-07-24', 'أنثى');
...
INSERT INTO `teachers` (`teacher_id`, `full_name`, `specialization`, `email`) VALUES
(1, 'منى الاغا', 'انجليزي', 'mona2026@gmail.com');
...
(1, 'admin', 'admin123', 'admin', '2026-05-23 13:01:07');
